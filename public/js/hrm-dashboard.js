...
var options = {
    ...
    plotOptions: {
        area: {
            // Ajustamos las opciones específicas para 'area' aquí si es necesario
            // Por ejemplo, puedes ajustar la opacidad de la línea y el relleno
            opacity: 0.5
        }
    },
    dataLabels: {
    ...
    fill: {
        opacity: 1 // Ajusta la opacidad del relleno si es necesario
    }
};
...
function JobsSummary() {
    chart.updateOptions({
        colors: ["rgba(0,255,0,0.6)", "rgba(255,0,0,0.7)"],
    })
};
/* Jobs Summary chart */